...
Notes: Ensure that the CV file path is correct and accessible during the test execution.
...
def run(playwright):
    ...
    try:
        ...
        assert success_message.is_visible(), 'Success message is not visible.'
