...
with sync_playwright() as p:
    ...
    try:
        ...
        try:
            ...
            logging.info('Successfully logged into the app.')

            # Check if the user is logged in by verifying an element on the dashboard
            assert page.is_visible('text=Welcome to your dashboard'), 'User is not logged in.'
            logging.info('User is logged in and dashboard is visible.')
